...
export class AboutmeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.serviceDesk = {title: Constant.deskDev, urlImage: "ssets/img/icons8-pc-48.png", desc:Constant.deskDesc};
    this.serviceWeb = {title: Constant.webDev, urlImage: "ssets/img/icons8-website-48.png", desc:Constant.webDesc};
